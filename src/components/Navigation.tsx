                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="flex items-center gap-3 group">
                        ...
                        <span className="font-bold text-xl hidden sm:block">
                            <span className="gradient-text">GoKart RFID</span>
                        </span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        ...
                        <Link
                            href="/admin/login"
                            className="px-4 py-2 bg-muted/50 hover:bg-muted transition-colors rounded-lg font-medium"
                        >
                            管理后台
                        </Link>
                    </div>
                    ...
                    <div className="md:hidden py-4 border-t border-border/50">
                        <div className="flex flex-col gap-2">
                            ...
                            <Link
                                href="/admin/login"
                                onClick={() => setIsMobileMenuOpen(false)}
                                className="px-4 py-3 bg-muted/50 hover:bg-muted transition-colors rounded-lg font-medium text-center"
                            >
                                管理后台
                            </Link>
                        </div>
